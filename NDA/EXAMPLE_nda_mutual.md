...
**TRUGS LLC**, a Washington limited liability company ("Company")

and

**_________________________** ("Counterparty")

Company and Counterparty are each a "Party" and together the "Parties." Because this Agreement is mutual, each Party is both a Disclosing Party and a Receiving Party.
...
- Source code, specifications, algorithms, and designs
...
- Information disclosed orally that is identified as confidential in writing within ten (10) days
...
**(b)** was known to the Receiving Party before disclosure, as shown by written records;

**(c)** is independently developed by the Receiving Party without use of the Confidential Information; or

**(d)** is received from a third party who is not under a confidentiality obligation to the Disclosing Party.
...
**(a)** protect Confidential Information using at least the same degree of care it uses for its own confidential information, but no less than reasonable care;

**(b)** use Confidential Information only for the Purpose;

**(c)** not disclose Confidential Information to anyone except its employees, contractors, and advisors ("Representatives") who need to know it for the Purpose and are bound by confidentiality obligations at least as protective as this Agreement;
...
If the Receiving Party is required by law, regulation, or court order to disclose Confidential Information, the Receiving Party shall:

**(a)** promptly notify the Disclosing Party (unless prohibited by law);

**(b)** cooperate with the Disclosing Party's efforts to obtain a protective order; and
...
**(c)** The confidentiality obligations in Section 5 survive termination for three (3) years. For information that qualifies as a trade secret under applicable law, the obligations continue for as long as the information remains a trade secret.
...
## 10. Whistleblower Immunity Notice
...
**(a)** An individual shall not be held criminally or civilly liable under any Federal or State trade secret law for the disclosure of a trade secret that is made in confidence to a government official or to an attorney solely for the purpose of reporting or investigating a suspected violation of law.

**(b)** An individual who files a lawsuit for retaliation by an employer for reporting a suspected violation of law may disclose the employer's trade secrets to the attorney and use the trade secret information in the court proceeding if the individual files any document containing the trade secret under seal and does not disclose the trade secret except pursuant to court order.
...
**(b) Jurisdiction.** Any dispute arising from this Agreement shall be resolved in the state or federal courts located in King County, Washington.

**(c) Entire Agreement.** This Agreement is the entire agreement between the Parties regarding confidentiality and supersedes all prior discussions on this subject.

**(d) Assignment.** Neither Party may assign this Agreement without the other Party's written consent.

**(e) Amendment.** This Agreement may only be amended in writing signed by both Parties.

**(f) Waiver.** Failure to enforce any provision is not a waiver of future enforcement.

**(g) Severability.** If any provision is unenforceable, the remaining provisions continue in effect.

## 12. Signatures

| | **TRUGS LLC** | **Counterparty** |
|---|---|---|
...
1. **RCW 19.108** — Washington Uniform Trade Secrets Act. https://app.leg.wa.gov/rcw/default.aspx?cite=19.108
   *Governing statute for trade secret claims, misappropriation definition, and remedies. Referenced in Sections 9 and 11.*

2. **18 U.S.C. § 1836 et seq.** — Defend Trade Secrets Act of 2016 (DTSA). https://www.congress.gov/bill/114th-congress/senate-bill/1890
   *Federal civil cause of action; § 1833(b) whistleblower immunity. Referenced in Section 10.*

3. **Uniform Trade Secrets Act** (1979, amended 1985). https://www.uniformlaws.org/committees/community-home?CommunityKey=3a2538fb-e030-4e2d-a9e2-90373dc05792
   *Model act adopted by 48 states including WA — foundation for RCW 19.108.*

### Legal Guidance

4. **American Bar Association**, "Best Practices for Negotiating and Entering into Nondisclosure Agreements." https://www.americanbar.org/groups/litigation/resources/newsletters/business-torts-unfair-competition/best-practices-negotiating-entering-nondisclosure-agreements/
   *Definition scope, standard exclusions, marking requirements, duration. Informed Sections 3, 4, and 7.*

5. **Contract Nerds**, "Stick to the Core: 8 Essential Provisions of Non-Disclosure Agreements." https://contractnerds.com/stick-to-the-core-8-essential-provisions-of-non-disclosure-agreements/
   *Practical checklist for core NDA clauses. Informed Section 5.*

6. **EveryNDA**, "11 Mistakes That Could Invalidate Your NDA." https://www.everynda.com/blog/11-ways-invalidate-nda/
   *Pitfalls — overbroad definitions, missing consideration, excessive duration. Informed Sections 3 and 4.*

7. **Association of Corporate Counsel**, "Issues Enforcing Nondisclosure Agreements (United States)." https://www.acc.com/resource-library/issues-enforcing-nondisclosure-agreements-united-states
   *State-specific enforceability and judicial reasonableness tests. Informed Section 7.*

8. **Contract Nerds**, "Ten Tips for Writing Clear Contracts." https://contractnerds.com/ten-tips-for-writing-clear-contracts/
   *Plain-language drafting — active voice, defined terms, eliminating legalese. Informed overall style.*

### Templates Referenced

9. **Bonterms Mutual NDA**, CC BY 4.0. https://github.com/Bonterms/Mutual-NDA
   *Open-source mutual NDA — balanced commercial starting point. Primary template reference.*

10. **Universal NDA (uNDA)**, Bitmovin / UC Hastings. https://github.com/bitmovin/unda
    *Standardized NDA for routine commercial transactions. Secondary template reference.*

### Reference

11. **Cornell Legal Information Institute**, "Trade Secret." https://www.law.cornell.edu/wex/trade_secret
    *Encyclopedia entry — federal and state trade secret law with links to UTSA and DTSA.*
